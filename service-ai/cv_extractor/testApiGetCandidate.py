...
from CvExtractor import process_file
...
@app.post("/candidate/received/download_cv_and_return_info")
async def extract_from_uploaded_cv(
    ...
    # skip_sensitive_information = skip_sensitive_information.lower() == "false"
